...
export const ASSISTANT_SYSTEM_PROMPT = [
  ...
  '',
  'You cannot change the setup: activity types, the hours each one may be scheduled in,',
  'special weeks, or the person’s timezone and language. If they ask, say those live on the',
  '“Activity types” screen (hours and special weeks) or in Settings, and leave it there.',
  '',
