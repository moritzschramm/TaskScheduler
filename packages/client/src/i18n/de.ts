...
export const de: Messages = {
  ...
  gettingStarted: {
    ...
    begin: 'Weiter',
    projectTitle: 'Woran arbeitest du gerade?',
    projectLead:
      'Ordnest du Aufgaben einer Aufgabe unter, wird daraus ein Projekt. Die Aufgaben darin übernehmen dessen Priorität, Frist und Wunschzeiten, sofern sie nichts anderes sagen, und nur sie werden eingeplant — im Projekt sagst du „dienstags nachmittags“ also einmal statt bei jeder Aufgabe. Du kannst das überspringen und später anlegen.',
    projectLabel: 'Das Projekt',
    projectPlaceholder: 'Abrechnung überarbeiten',
    firstTaskLabel: 'Das Erste, was darin zu tun ist',
    firstTaskPlaceholder: 'Neue Tarifauswahl spezifizieren',
  ...
  tasks: {
    title: 'Aufgaben',
    lead: 'Eine Aufgabe ist ein Stück Arbeit, das du erledigen willst: Eine Schätzung, wie lange sie dauert, die Aktivitätsart, in deren Stunden sie geplant werden darf, und wahlweise eine Priorität und ein Fälligkeitsdatum. Ordnest du verwandte Aufgaben einer von ihnen unter, wird daraus ein Projekt: Die Aufgaben darin übernehmen dessen Priorität, Frist und Wunschzeiten, sofern sie nichts anderes sagen, und nur sie werden eingeplant. Was nicht in den Planungszeitraum passt, wartet im Rückstand.',
    newTask: 'Neue Aufgabe',
    empty: 'Noch keine Aufgaben.',
    breakUp: 'Aufteilen',
    addTask: 'Aufgabe hinzufügen',
    addSubtask: 'Aufgabe darin anlegen',
    addSubtaskTo: 'Aufgabe in {title} anlegen',
    ...
    footnote:
      'Nach Aktivitätsart gruppiert. Eine Aufgabe mit Aufgaben darunter ist ein Projekt: Sie wird nicht selbst eingeplant, und ihre Schätzung ist die Summe der Arbeit darin. Kursiv gesetzte Werte sind geerbt oder aufsummiert, nicht hier gesetzt. Aufgaben lassen sich höchstens fünf Ebenen tief verschachteln.',
    progress: '{done}/{total} erledigt',
    choose: '{title} zum Verschieben auswählen',
    foldProject: '{title} einklappen',
    chosen: {
      one: '{count} Aufgabe ausgewählt',
      other: '{count} Aufgaben ausgewählt',
    },
    moveChosen: 'Ausgewählte Aufgaben verschieben',
    chooseDestination: 'Verschieben unter…',
    ...
    quickAddUnder: 'Aufgabe hier hinzufügen…',
  ...
  settings: {
    ...
    assistantLead:
      'Der Assistent spricht über deinen eigenen API-Schlüssel mit einem Modell und kann Änderungen nur vorschlagen — du bestätigst jede einzeln, bevor etwas passiert.',
    assistantProvider: 'Anbieter',
    assistantKey: 'API-Schlüssel',
    assistantKeyHint:
      'Verschlüsselt auf dem Server gespeichert und nie wieder angezeigt. Füge einen neuen ein, um ihn zu ersetzen.',
    assistantModel: 'Modell',
    assistantModelHint: 'Leer lassen für {model}.',
    assistantSave: 'Schlüssel speichern',
    assistantSaved: 'Schlüssel mit der Endung {hint} wird mit {model} verwendet.',
    assistantRemove: 'Schlüssel entfernen',
    assistantNone: 'Noch kein Schlüssel, der Assistent ist also aus.',
    title: 'Einstellungen',
  ...
  editor: {
    ...
    soft: 'Weich',
    hard: 'Hart',
    weekdaysLabel: 'Wunschtage',
    weekdaysHint: 'Welche Tage, zu den Stunden darüber. Beides lässt sich einzeln setzen.',
  ...
  assistant: {
    open: 'Assistenten fragen',
    close: 'Assistenten schließen',
    title: 'Assistent',
    lead: 'Frag nach deiner Woche oder sag, was sich ändern soll. Nichts passiert, bevor du zustimmst.',
    placeholder: 'Verschiebe die Rechnungen auf Donnerstag…',
    send: 'Senden',
    reset: 'Von vorn',
    thinking: 'Denkt nach…',
    failed: 'Der Assistent war nicht erreichbar',
    disabled: 'Hinterlege einen API-Schlüssel, um den Assistenten zu nutzen.',
    disabledLink: 'Einstellungen öffnen',
    truncated: 'Diese Antwort wurde abgeschnitten.',
    capped: 'Mehr Änderungen darf eine Antwort nicht vorschlagen. Frag für den Rest noch einmal.',
    stepLimit: 'Hier ist Schluss — sag, was als Nächstes passieren soll.',
    noCalendar: 'Es gibt noch keinen Planer, der geändert werden könnte.',
    undone: 'Zurückgenommen.',
    plan: {
      heading: 'Vorgeschlagene Änderungen',
      apply: 'Anwenden',
      discard: 'Verwerfen',
      undo: 'Rückgängig',
      applying: 'Wird angewendet…',
      applied: 'Angewendet',
      partly: 'Teilweise angewendet',
      declined: 'Verworfen',
      willNotRun: 'Das hier läuft nicht',
      unknown: 'etwas, das nicht in dieser Woche liegt',
      untitledBlock: 'ein Block ohne Titel',
      CreateTask: 'Neue Aufgabe „{title}“',
      EditTask: '{what} ändern',
      MoveTask: '{what} für {when} vormerken',
      ClearFloor: '{what} wieder frei planen lassen',
      CompleteTask: '{what} als erledigt markieren',
      CancelTask: '{what} verwerfen',
      ExtendTask: '{what} neu auf {minutes} Minuten schätzen',
      DeferTask: '{what} verschieben',
      SwapTasks: 'Zeiten von {a} und {b} tauschen',
      SwapForward: '{what} hinter das Folgende schieben',
      MoveToBacklog: '{what} in den Rückstand schieben',
      PromoteFromBacklog: '{what} aus dem Rückstand holen',
      AddAppointment: 'Neuer Termin „{title}“, {when}',
      AddUnavailability: '{when} blockieren',
      EditAppointment: '{what} ändern',
      CancelAppointment: '{what} absagen',
      ...
      EditWeekTypeOverride: 'Sonderwoche {what} ändern',
      DeleteWeekTypeOverride: 'Sonderwoche {what} samt ihrer Zeiten löschen',
      defer: {
        tomorrow: '{what} auf morgen verschieben',
        next_week: '{what} auf nächste Woche verschieben',
        backlog: '{what} in den Rückstand verschieben',
      },
    },
    field: {
      cleared: 'gelöscht',
      name: 'Name',
      color: 'Farbe',
      defaultCooldownMin: 'Standard-Abklingzeit (Minuten)',
      startDate: 'Ab',
      endDate: 'Bis, ausschließlich',
      windows: 'Zeiten',
      noWindows: 'gar keine — hier wird davon nichts geplant',
      removed: 'Entfällt',
      title: 'Titel',
      notes: 'Notizen',
      ...
      priority: 'Priorität',
      dueDate: 'Fällig',
      preferredRange: 'Bevorzugte Zeit',
      focusLevel: 'Konzentrationsgrad',
      cooldownOverrideMin: 'Abklingzeit (Minuten)',
      cooldownMin: 'Abklingzeit (Minuten)',
      recurrence: 'Wiederholung',
      status: 'Status',
      scope: 'Gilt für',
      reason: 'Grund',
      actualEnd: 'Beendet um',
      interval: 'Wann',
      isInternal: 'Alle sind App-Nutzer',
      soft: 'weich',
      hard: 'hart',
      day: 'Tag',
      week: 'Woche',
      month: 'Monat',
      perPeriod: '{count}× pro {period}',
    },
  },
