...
docker run --network=taskscheduler_skynet --rm -v ./migrations:/liquibase/changelog liquibase/liquibase --url="jdbc:$db_dsn" --changeLogFile="root.changelog.yml" --username=$POSTGRES_USER --password=$POSTGRES_PASSWORD update
